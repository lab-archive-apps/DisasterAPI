...
$app->group('/api', function () {
    /* === Auth === */
    $this->post('/postLogin', '\App\Controller\API\AuthController:postLogin')->setName('post_login');
    $this->post('/postLogout', '\App\Controller\API\AuthController:postLogout')->setName('post_logout');
